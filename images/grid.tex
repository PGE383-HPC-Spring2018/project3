...
\begin{document}
    ...
    \node[font=\small] at (9.55,4.25) {$u(x_{\mbox{max}},y) = 10$};
    \node[font=\small] at (7.0,4.25) {$u(x_{\mbox{min}},y) = 10$};
    \node[font=\small] at (8.25,5.1) {$u(x, y_{\mbox{max}}) = 0$};
    \node[font=\small] at (8.25,3.35) {$u(x, y_{\mbox{min}}) = 0$};
